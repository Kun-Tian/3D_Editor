...
class line3d
{
	public:
		...
		double getLengthSQ() const { return start.getDistanceFromSQ(end); };
		...
		bool getIntersectionWithSphere(vector3d<T> sorigin, T sradius, double& outdistance)
		{
