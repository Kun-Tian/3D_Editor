...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_View3D_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_View3D_t qt_meta_stringdata_View3D = {
    {
QT_MOC_LITERAL(0, 0, 6), // "View3D"
QT_MOC_LITERAL(1, 7, 16), // "xRotationChanged"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 5), // "angle"
QT_MOC_LITERAL(4, 31, 16), // "yRotationChanged"
QT_MOC_LITERAL(5, 48, 16), // "zRotationChanged"
QT_MOC_LITERAL(6, 65, 12), // "setXRotation"
QT_MOC_LITERAL(7, 78, 12), // "setYRotation"
QT_MOC_LITERAL(8, 91, 12), // "setZRotation"
QT_MOC_LITERAL(9, 104, 12) // "drawTriangle"

    },
    "View3D\0xRotationChanged\0\0angle\0"
...
void View3D::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (View3D::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&View3D::xRotationChanged)) {
                *result = 0;
            }
        }
        {
            typedef void (View3D::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&View3D::yRotationChanged)) {
                *result = 1;
            }
        }
        {
            typedef void (View3D::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&View3D::zRotationChanged)) {
                *result = 2;
            }
        }
    }
...
const QMetaObject View3D::staticMetaObject = {
    { &QGLWidget::staticMetaObject, qt_meta_stringdata_View3D.data,
...
void *View3D::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_View3D.stringdata))
...
// SIGNAL 0
void View3D::xRotationChanged(int _t1)
{
...
// SIGNAL 1
void View3D::yRotationChanged(int _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void View3D::zRotationChanged(int _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
